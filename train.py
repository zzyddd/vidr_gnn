...
parser.add_argument('--initial-checkpoint', default=r'', type=str, metavar='PATH',
...
def train_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        with amp_autocast():
            output, Discriminative_Reorganization_Loss = model(input)
            loss = loss_fn(output, target) + Discriminative_Reorganization_Loss
